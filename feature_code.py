...
def PSTNPds(inf, sequence_all, cell_line):
    ...
    positive_number = len(positive)
    print('ppsitive_number', positive_number)
    if cell_line != 'IMR90/':
        negative_number = len(negative)
    count = 0
    for i in fastas_new:
...
# filename = 'data/MCF7/MCF7_RR_left_train'
# cell_line = 'MCF7/'

# filename = 'dataOfIMR90/reverse-forward orientation pairs/forward'
# cell_line = 'IMR90/'

filename = 'data/K562/k562_FF_left_train'
cell_line = 'K562/'
...
# filename = 'data/MCF7/MCF7_RR_right_train'
# cell_line = 'MCF7/'

# filename = 'dataOfIMR90/reverse-forward orientation pairs/reverse'
# cell_line = 'IMR90/'

filename = 'data/K562/K562_FF_right_train'

# inf = filename + '.txt'
# outf = filename + '01.txt'
inf = filename + '.fasta'
outf = filename + '.txt'
readwrite(inf, outf)
...
def load(feature1_1, feature1_2, feature2_1, feature2_2, x3_1, x3_2, x4_1, x4_2, feature5_1, feature5_2):
    ...
    print('feature1_1.shape:', feature1_1.shape)
    print('feature1_2.shape:', feature1_2.shape)
    print('feature2_1.shape:', feature2_1.shape)
    print('feature2_2.shape:', feature2_2.shape)
    print('feature3_1.shape:', feature3_1.reshape(-1, 1).shape)
    print('feature3_2.shape:', feature3_2.reshape(-1, 1).shape)
    print('feature4_1.shape:', feature4_1.reshape(-1, 1).shape)
    print('feature4_2.shape:', feature4_2.reshape(-1, 1).shape)
    print('feature5_1.shape:', feature5_1.shape)
    print('feature5_2.shape:', feature5_2.shape)
...
# np.save('data/MCF7npy/MCF7_RR_train.npy', x)
# np.save('dataOfIMR90/rf.npy', x)
np.save('data/K562npy/K562_FF_train.npy', x)
